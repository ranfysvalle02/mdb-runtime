#!/usr/bin/env python3
"""
Bundled Startup Script for Oblivio Apps v0
==========================================
...
Port Mapping:
- Port 8000: oblivio-auth-hub (master app)
- Port 8001: oblivio-sso-app-1
- Port 8002: oblivio-sso-app-2
- Port 8003: oblivio-sso-app-3
"""
...
def main() -> None:
    ...
    logger.info("=" * 60)
    logger.info("Starting All Oblivio Apps (Bundled Mode)")
    logger.info("=" * 60)

    # App configuration: (module_path, port, display_name)
    apps: list[tuple[str, int, str]] = [
        ("oblivio-auth-hub/web.py", 8000, "Oblivio Auth Hub"),
        ("oblivio-sso-app-1/web.py", 8001, "Oblivio SSO App 1"),
        ("oblivio-sso-app-2/web.py", 8002, "Oblivio SSO App 2"),
        ("oblivio-sso-app-3/web.py", 8003, "Oblivio SSO App 3"),
    ]
