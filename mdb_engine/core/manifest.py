...
MANIFEST_SCHEMA_V2 = {
    ...
    "properties": {
        ...
        "memory_config": {
            ...
            "additionalProperties": False,
            "description": "Mem0 memory service configuration. Enables intelligent memory management that automatically extracts, stores, and retrieves user memories. Uses MongoDB as the vector store (native integration with mdb-engine). mem0 handles embeddings and LLM via environment variables (.env). Configure AZURE_OPENAI_API_KEY/AZURE_OPENAI_ENDPOINT or OPENAI_API_KEY in your .env file."
        },
        "cors": {
            "type": "object",
            "properties": {
